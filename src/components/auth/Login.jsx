...
export default function Login({ onSwitchToSignup, onLoginSuccess }) {
    ...
    return (
        ...
        >
            <div className="w-full max-w-lg bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        className="w-full py-3 bg-black text-white rounded-xl font-bold hover:bg-gray-800 transition-colors shadow-lg"
                    >
                        Login
                    </button>
